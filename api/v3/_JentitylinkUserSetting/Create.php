...
/**
 * JentitylinkUserSetting.Create API specification (optional)
 ...
 */
function _civicrm_api3_jentitylink_user_setting_Create_spec(&$spec) {
}

/**
 * JentitylinkUserSetting.Create API
 *
 * @param array $params
 *
 * @return array
 ...
 */
function civicrm_api3_jentitylink_user_setting_create($params) {
  if (array_key_exists('magicword', $params) && $params['magicword'] == 'sesame') {
    ...
    return civicrm_api3_create_success($returnValues, $params, 'JentitylinkUserSetting', 'Create');
  }
  else {
